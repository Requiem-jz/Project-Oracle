    ...
    generateMiniFiles(compilation, compiler) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            this.pages.forEach(page => {
                ...
                if (config) {
                    const importBaseCompPath = (0, helper_1.promoteRelativePath)(node_path_1.default.relative(page.path, node_path_1.default.join(sourceDir, this.getTargetFilePath(baseCompName, ''))));
                    const importCustomWrapperPath = (0, helper_1.promoteRelativePath)(node_path_1.default.relative(page.path, node_path_1.default.join(sourceDir, this.getTargetFilePath(customWrapperName, ''))));
                    config.content.usingComponents = Object.assign({}, config.content.usingComponents);
                    if (isUsingCustomWrapper) {
                        config.content.usingComponents[customWrapperName] = importCustomWrapperPath;
                    }
